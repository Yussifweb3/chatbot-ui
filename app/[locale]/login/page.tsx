...
export default async function Login({
  ...
  if (session) {
    ...
    if (error || !homeWorkspace) {
      // Handle the case where no home workspace exists
      console.error("No home workspace found for user:", session.user.id);
      return redirect("/setup"); // Redirect to a setup page or show an error
    }
  ...
  // Get environment variable or Edge Config value
